...
import com.appnerds.hrishikesh.firechat.analytics.Analytics;
import com.appnerds.hrishikesh.firechat.analytics.FirebaseAnalyticsAnalytics;
import com.appnerds.hrishikesh.firechat.conversation.database.FirebaseConversationDatabase;
import com.appnerds.hrishikesh.firechat.conversation.service.ConversationService;
import com.appnerds.hrishikesh.firechat.conversation.service.PersistedConversationService;
import com.appnerds.hrishikesh.firechat.conversation_list.database.FirebaseConversationListDatabase;
import com.appnerds.hrishikesh.firechat.conversation_list.service.ConversationListService;
import com.appnerds.hrishikesh.firechat.conversation_list.service.PersistedConversationListService;
import com.appnerds.hrishikesh.firechat.global.database.FirebaseGlobalDatabase;
import com.appnerds.hrishikesh.firechat.global.service.GlobalService;
import com.appnerds.hrishikesh.firechat.global.service.PersistedGlobalService;
import com.appnerds.hrishikesh.firechat.login.database.FirebaseAuthDatabase;
import com.appnerds.hrishikesh.firechat.login.service.FirebaseLoginService;
import com.appnerds.hrishikesh.firechat.login.service.LoginService;
import com.appnerds.hrishikesh.firechat.main.database.FirebaseCloudMessagingDatabase;
import com.appnerds.hrishikesh.firechat.main.service.CloudMessagingService;
import com.appnerds.hrishikesh.firechat.main.service.FirebaseCloudMessagingService;
import com.appnerds.hrishikesh.firechat.main.service.MainService;
import com.appnerds.hrishikesh.firechat.main.service.PersistedMainService;
import com.appnerds.hrishikesh.firechat.profile.service.FirebaseProfileService;
import com.appnerds.hrishikesh.firechat.profile.service.ProfileService;
import com.appnerds.hrishikesh.firechat.registration.service.FirebaseRegistrationService;
import com.appnerds.hrishikesh.firechat.registration.service.RegistrationService;
import com.appnerds.hrishikesh.firechat.rx.FirebaseObservableListeners;
import com.appnerds.hrishikesh.firechat.storage.FirebaseStorageService;
import com.appnerds.hrishikesh.firechat.storage.StorageService;
import com.appnerds.hrishikesh.firechat.user.database.FirebaseUserDatabase;
import com.appnerds.hrishikesh.firechat.user.service.PersistedUserService;
